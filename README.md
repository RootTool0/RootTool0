...
<image src="IMG_20251201_113136_340.jpg" />
...
- Processing
- Arduino
- Физика, Математика, глубокое знание Электроники и понимание основ в Computer Science
...
- **Portal Solver API** - Полностью открытый **API** для игры **Portal: Solver** на языке **Python**, имеющий в себе базовые инструменты, инструкции и документации для работы с редактором карт и всей игрой из кода
