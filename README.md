...
## Обо мне? 
Простой паренек, 16 лет, крайне веселый, забывчивый и тихий _(Интроверт проще говоря-)_
...
- **Portal Solver API** - Полностью открытый **API** для языка **Python**, имеющий в себе инструменты, инструкции и документацию для редактора карт в игре **Portal: Solver**
